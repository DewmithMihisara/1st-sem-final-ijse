...
CREATE TABLE Cut(
    ...
    Size VARCHAR(4),
    Colour VARCHAR(10),
    FOREIGN KEY (CutID)REFERENCES Orders(OrderID)ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Material(
    ...
    MaterialQty INT(30),
    Date DATE,
    CONSTRAINT FOREIGN KEY  (MaterialID)REFERENCES Orders(OrderID)ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Stock(
    ...
    CONSTRAINT FOREIGN KEY (StockID)REFERENCES Shipment(ShipID)ON DELETE CASCADE ON UPDATE CASCADE
);
